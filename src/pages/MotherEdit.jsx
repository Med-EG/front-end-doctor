...
function MotherEdit() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("Mother updated successfully!");
      handleShowNotification("Mother updated successfully!", true);
    } catch (error) {
      console.error("Error updating Mother:", error);
      handleShowNotification("Error updating Mother's info", false);
    }
  };
