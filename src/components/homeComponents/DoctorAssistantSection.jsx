...
function DoctorAssistantSection() {
  return (
    <div className="w-10/12 lg:py-20 m-auto gap-10 flex lg:flex-row md:flex-col sm:flex-col xs-flex-col justify-center items-center p-14 rounded-xl shadow-lg shadow-gray-400 bg-gray-100">
...
export default DoctorAssistantSection;
